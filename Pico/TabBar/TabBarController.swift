...
final class TabBarController: UITabBarController {
    ...
    private func configureTabBar() {
        ...
        mailViewController.tabBarItem = UITabBarItem(title: "", image: UIImage(systemName: "envelope.fill"), tag: 1)
        likeViewController.tabBarItem = UITabBarItem(title: "", image: UIImage(systemName: "heart.fill"), tag: 2)
        entViewController.tabBarItem = UITabBarItem(title: "", image: UIImage(systemName: "gamecontroller.fill"), tag: 3)
        mypageViewController.tabBarItem = UITabBarItem(title: "", image: UIImage(systemName: "person.fill"), tag: 4)
        ...
        self.viewControllers = [homeViewController, mailViewController, likeViewController, entViewController]
        delegate = self
    }
