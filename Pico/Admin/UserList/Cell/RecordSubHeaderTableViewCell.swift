//
//  RecordSubHeaderTableViewCell.swift
//  Pico
//
//  Created by 최하늘 on 10/19/23.
//

import UIKit
import RxSwift

final class RecordSubHeaderTableViewCell: UITableViewCell {
...
// MARK: - 컬렉션뷰 관련
extension RecordSubHeaderTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
// MARK: - UI 관련
extension RecordSubHeaderTableViewCell {
    func addViews() {
